...
module.exports = {
  ...
  title: 'Documentación técnica de LUKSO',
  tagline:
    'Redes, Estándares, Guías y Herramientas para desarrollar en LUKSO.',
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Equipo', href: 'https://lukso.network/people' },
            { label: 'Empleos', href: 'https://jobs.lukso.network/jobs' },
            {
